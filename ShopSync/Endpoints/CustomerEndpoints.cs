...
namespace ShopSync.Endpoints
{
    public static class CustomerEndpoints
    {
        public static void MapCustomerEndpoints(this WebApplication app)
        {
            ...
            // ✅ Get customer by Id
            app.MapGet("/api/customers/{id}", async (string id, ShopSyncContext db) =>
            ...
            app.MapPut("/api/customers/{id}", async (string id, Customer updatedCustomer, ShopSyncContext db) =>
            {
            ...
            // ✅ Delete customer
            app.MapDelete("/api/customers/{id}", async (string id, ShopSyncContext db) =>
            {
                var customer = await db.Customers.FindAsync(id);
                if (customer is null) return Results.NotFound();
